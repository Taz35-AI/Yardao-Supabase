  ...
  return (
    <main className="login-shell login-shell--recovery" aria-labelledby="page-title">
      ...
      <style jsx global>{`
        ...
        /* Recovery: warm the beam a touch so it reads distinct from the login */
        .login-shell--recovery .light-beam {
          background:
            radial-gradient(ellipse at 22% 46%, rgba(255, 208, 56, 0.16), transparent 40%),
            radial-gradient(ellipse at 52% 52%, rgba(214, 255, 47, 0.08), transparent 54%),
            radial-gradient(ellipse at 76% 58%, rgba(255, 138, 0, 0.07), transparent 58%);
        }
        ...
        .eyebrow--recovery { color: var(--gold); }
        ...
        .panel-glow { inset: auto -30% -42% 20%; height: 14rem; border-radius: 999px; background: rgba(255, 208, 56, 0.16); filter: blur(46px); }
        ...
        .reset-tile {
          ...
          color: #06210f; box-shadow: 0 0 30px rgba(255, 184, 28, 0.4);
        }
        .reset-tile svg { width: 1.7rem; height: 1.7rem; fill: none; stroke: currentColor; stroke-width: 1.9; stroke-linecap: round; stroke-linejoin: round; }
        ...
        .field-icon {
          ...
          width: 1.15rem; height: 1.15rem; fill: none; stroke: var(--lime-bright); stroke-width: 1.7;
        ...
        .input-with-icon input { padding-left: 2.85rem; }
        ...
        .submit-button {
          ...
          border: 0; border-radius: 16px; overflow: hidden; width: 100%; text-align: center;
        ...
        .recovery-success__text { margin: 0 0 0.4rem; max-width: 24rem; color: var(--muted); font-size: 0.94rem; line-height: 1.6; }
        .recovery-success__text strong { color: var(--ink); }
        .submit-button--link { text-decoration: none; max-width: 22rem; margin: 0.35rem auto 0; }
        .link-button {
          margin-top: 0.15rem; border: 0; background: transparent; color: var(--gold); font-weight: 700;
          font-size: 0.86rem; cursor: pointer;
        }
        .link-button:hover { text-decoration: underline; text-underline-offset: 0.24em; }

        .panel-footer { display: flex; align-items: center; justify-content: space-between; gap: 1rem; margin-top: 1.4rem; padding-top: 1.25rem; border-top: 1px solid rgba(226, 255, 177, 0.12); color: var(--soft); font-size: 0.86rem; }
        ...
        @media (max-width: 520px) {
          ...
          .reset-tile { width: 2.55rem; height: 2.55rem; border-radius: 0.9rem; }
          .reset-tile svg { width: 1.4rem; height: 1.4rem; }
          ...
          .panel-footer { align-items: center; flex-wrap: wrap; gap: 0.45rem 0.65rem; margin-top: 0.7rem; padding-top: 0.75rem; }
