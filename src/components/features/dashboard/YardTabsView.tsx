...
const RegPlate = ({ registration }: { registration: string }) => (
  <span
    ...
    style={{
      // UK front-plate style: white with a black border + black characters
      // (rear plates are yellow — too much yellow on the dashboard).
      background: '#ffffff',
  ...
  >
    <span style={{ fontSize: '12px', fontWeight: 800, color: '#111111', letterSpacing: '0.10em', lineHeight: 1 }}>
      {registration}
    </span>
  </span>
)
