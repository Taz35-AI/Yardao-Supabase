// src/lib/services/bulkInsuranceService.ts — SUPABASE re-implementation.
// Bulk insurance operations for fleet vehicles. Public class, method signatures,
// result shapes and throw/return semantics are unchanged from the Firestore
// version — only the data-access internals are swapped to Supabase.
